...
const Painpoint: React.FC = () => {
    return (
        <section id="painpoint" className="border-b border-neutral-900 py-20 px-6 md:px-12 lg:px-20">
            <div className="mx-auto max-w-360 w-full">
                ...
                <div className="hidden lg:grid grid-cols-[3fr_2fr] items-end gap-12">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <h2 className="font-heading text-5xl font-bold text-neutral-100 leading-tight">
                ...
                <div className="lg:hidden flex flex-col gap-8">
                    <div className="flex flex-col gap-3 text-center">
                        ...
                        <h2 className="font-heading text-xl font-bold text-neutral-100 leading-tight">
                            The struggle before Panda Pay.
                        </h2>
                    </div>
                    <img
