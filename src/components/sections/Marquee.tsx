...
const Marquee: React.FC = () => {
    return (
        <div className="relative w-full overflow-hidden flex flex-col justify-center items-center pb-4 pt-10">
            ...
            <div className="group w-[110vw] -ml-[5vw] bg-neutral-900/60 backdrop-blur-md border-y border-neutral-800 py-4 -rotate-2 transform-gpu">
                        ...
                        <div key={arrayIndex} className="flex items-center gap-8 px-4">
                            {MARQUEE_ITEMS.map((item, index) => (
                                <div key={`${arrayIndex}-${index}`} className="flex items-center gap-6">
                                    ...
                                    <span className="font-heading font-bold text-neutral-100 text-lg md:text-xl lg:text-2xl tracking-wide">
                                        {item}
                                    </span>
                                </div>
                            ))}
