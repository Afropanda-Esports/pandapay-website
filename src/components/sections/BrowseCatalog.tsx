...
const BrowseCatalog: React.FC = () => {
    return (
        <section id="browse-catalog" className="w-full bg-background py-12 lg:py-20 border-b border-neutral-900">
            <div className="mx-auto w-full max-w-360 px-4 py-12 lg:px-20 lg:py-0">
                ...
                <div className="flex flex-col lg:flex-row justify-between items-start gap-12 w-full mb-12">
                    {/* Left: Title */}
                    <h2 className="font-heading text-4xl md:text-5xl lg:text-6xl leading-[1.1] font-bold text-neutral-100  tracking-tight">
                    ...
                    <div className="flex flex-col items-start lg:items-end gap-6 max-w-[320px] shrink-0 lg:pt-2">
                        <p className="font-sans text-neutral-400 text-sm md:text-base leading-relaxed lg:text-right">
                        ...
                        >
                            ...
                            <span className="w-7 h-7 rounded-full bg-neutral-900 flex items-center justify-center shrink-0">
                ...
                >
                    <div className="flex w-fit whitespace-nowrap gap-6 md:gap-8 animate-marquee-slow hover:[animation-play-state:paused]">
                        {/* Render array twice for infinite smooth loop */}
